/**
 * Menu functionality for embed player
 * Extracted from embed.core.js for better modularity
 * Includes scrollbar fixes from player.menu.js
 */

/**
 * Ensure button has transparent menu button styling
 */
...
/**
 * Style back button with highlight
 */
...
/**
 * Build a scrollable container for menu lists with proper height constraints and scrollbar
...
/**
 * Remove future subtitles section if present
 */
...
/**
 * Insert a main menu entry
 */
export function insertMainEntry(menu, label, action, extra = {}) {
  if (!menu) return null;
...
/**
 * MenuManager class to handle menu state and operations
 */
export class MenuManager {
  constructor(menu) {
    this.menu = menu;
    this.menuView = 'main'; // main | speed | langs | subs | quality | download
    this.menuMainHTML = '';
  ...
  openMainView(callbacks) {
    ...
    // Quality/Download entries are injected by callbacks from embed.core.js.
