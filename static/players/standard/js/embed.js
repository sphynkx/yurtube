(function () {
  ...
  function detectPlayerName(){
    try{ var u=new URL(import.meta.url); var m=u.pathname.match(/\/static\/players\/([^\/]+)\//); if(m && m[1]) return m[1]; }catch(e){}
    try{ var s=(document.currentScript&&document.currentScript.src)||""; var m2=s.match(/\/static\/players\/([^\/]+)\//); if(m2 && m2[1]) return m2[1]; }catch(e2){}
  ...
  function initAll(){
    ...
    window.__YRP_STD_EMBED_NAME = PLAYER_NAME;
